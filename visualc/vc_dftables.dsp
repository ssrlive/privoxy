...
PostBuild_Cmds=$(OutDir)\vc_dftables.exe >$(WkspDir)\..\pcre\chartables.c
...
SOURCE=$(InputPath)
PostBuild_Desc=Running program to generate chartables.c
PostBuild_Cmds=$(OutDir)\vc_dftables.exe >$(OutDir)\..\..\pcre\chartables.c
# End Special Build Tool
...
"$(WkspDir)\..\src\config.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy "$(InputPath)" "$(WkspDir)\..\src\config.h"
